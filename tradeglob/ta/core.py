...
from tradeglob.ta._typing import *
from tradeglob.ta.maps import Category, Imports
...
class AnalysisIndicators(object):
    ...
    _custom = None
    _df = DataFrame()
    _ds = None  # Will be set in __init__ if needed
    _exchange = "NYSE"
    _last_run = None  # Will be set in __init__
    _time_range = "years"
    ...
    def indicators(self, as_list: bool = None, exclude: ListStr = None) -> TextIO | ListStr:
        ...
        if indicator_count > 0:
            from tradeglob.ta.candle.cdl_pattern import ALL_PATTERNS
    ...
    def ticker(self,
        ...
        Example:
            ...
            import tradeglob.ta as pandas_ta as ta
...
# Import all indicator functions after class definition to avoid circular imports
